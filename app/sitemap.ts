...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/calc/parental-leave`, lastModified: TOOL_UPDATED, changeFrequency: "monthly", priority: 0.9 },
    { url: `${SITE_URL}/calc/benefits`, lastModified: TOOL_UPDATED, changeFrequency: "monthly", priority: 0.9 },
    { url: `${SITE_URL}/calc/vaccine`, lastModified: TOOL_UPDATED, changeFrequency: "monthly", priority: 0.9 },
    { url: `${SITE_URL}/calc/work-reduction`, lastModified: TOOL_UPDATED, changeFrequency: "monthly", priority: 0.9 },
